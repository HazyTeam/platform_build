...
custom_local_manifest = ".repo/local_manifests/hazy_manifest.xml"
custom_default_revision = "hazy-mallow"
custom_dependencies = "hazy.dependencies"
org_manifest = "Hazy"  # leave empty if org is provided in manifest
org_display = "Hazy"  # needed for displaying
